...
import { FiAlignJustify, FiBell, FiMail } from 'react-icons/fi'
import { startLogout } from '../../../core/store/auth/thunk';
// import {  } from '../../../core/const/'
    ...
    return (
        <nav className="navbar navbar-expand-lg main-navbar sticky">
            <div className="form-inline mr-auto">
                <ul className="navbar-nav mr-3" id='menu-btn'>
                    <li><a href="#" className="nav-link nav-link-lg
            ...
            <ul className="navbar-nav navbar-right">
                    ...
                    <div className="dropdown-menu dropdown-list dropdown-menu-right pullDown">
                        ...
                        <div className="dropdown-list-content dropdown-list-message">
                            <a href="#" className="dropdown-item"> <span className="dropdown-item-avatar
                                text-white"> <img alt="image" src={ImagesUrl.user1} className="rounded-circle" />
                                ...
                                <img alt="image" src={ImagesUrl.user2} className="rounded-circle" />
                                ...
                                <img alt="image" src={ImagesUrl.user5} className="rounded-circle" />
                                ...
                                <img alt="image" src={ImagesUrl.user4} className="rounded-circle" />
                                ...
                                <img alt="image" src={ImagesUrl.user3} className="rounded-circle" />
                ...
                <li className="dropdown"><a href="#" onClick={toggleDropdown} data-toggle="dropdown"
                    className="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src={ImagesUrl.user1}
                        className="user-img-radious-style" /> <span className="d-sm-none d-lg-inline-block"></span></a>
                    <div className={`dropdown-menu dropdown-menu-right pullDown ${isOpen ? 'show' : ''}`}>
