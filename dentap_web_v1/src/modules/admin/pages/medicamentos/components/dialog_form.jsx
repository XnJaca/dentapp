...
import { CustomInputText } from '../../../pages/user/components';
import { closeDialog, updateContentDialog } from '../../../../../core/store/dialog';
import Swal from 'sweetalert2';
import { startSaveMedicamento, startUpdateMedicamento } from '../../../../../core/store/medicamentos/thunk';
...
export const DialogForm = () => {
    ...
    const saveData = () => {
        ...
        if (dialog.content.every(campo => campo.value)) {
            ...
            if (dialog.modificar) {
                dispatch(startUpdateMedicamento(dialog.content)).then(
                ...
                dispatch(startSaveMedicamento(dialog.content)).then(
