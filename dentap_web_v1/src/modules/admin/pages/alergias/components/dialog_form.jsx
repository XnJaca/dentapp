...
import { startSaveAlergia, startUpdateAlergia } from '../../../../../core/store/alergias/thunk';
...
export const DialogForm = () => {
    ...
    const saveData = () => {
        ...
        if (dialog.content.every(campo => campo.value)) {
            ...
            if (dialog.modificar) {
                dispatch(startUpdateAlergia(dialog.content)).then(
                ...
                dispatch(startSaveAlergia(dialog.content)).then(
