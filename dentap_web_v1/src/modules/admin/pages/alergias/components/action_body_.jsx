...
import { startDeleteEnfermedad } from '../../../../../core/store/enfermedades/thunk';
import { startDeleteAlergia } from '../../../../../core/store/alergias/thunk';
...
export const ActionBody = ({ selectedRowData, concept }) => {
    ...
    const editRow = () => {
        ...
        const content = campos(selectedRowData[0].id, selectedRowData[0].nombre, selectedRowData[0].descripcion);
    ...
    const deleteRow = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                dispatch(startDeleteAlergia(selectedRowData[0].id)).then(
                    Swal.fire(
                        'Eliminado!',
