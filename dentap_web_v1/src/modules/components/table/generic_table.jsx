...
export const GenericTable = ({ headers, concept, data, contentForm }) => {
    ...
    const left_toolbar_table = () => {
        return (
            <LeftToolBarTable concept={"Ingresar nueva enfermedad"} content={contentForm} />
        );
    }
        ...
        <>
            ...
            <div className="card">
                ...
                >
                    ...
                    {/* <Column
                        body={<ActionBody rowData={data}></ActionBody>}
                        exportable={false}
                        style={{ minWidth: "12rem" }}
                    /> */}
